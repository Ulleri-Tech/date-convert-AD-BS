import { DaysEachMonthBS } from "./types";

// 1943 April 14 to 2044 April 16(nearly)
export const numberOfDaysEachYearBS = {
    '2000': 365,
    '2001': 365,
    '2002': 365,
    '2003': 366,
...
export const numberOfDaysEachMonthBS:DaysEachMonthBS= {
...
export const NEPALI_NUMBER = ['०', '१', '२', '३', '४', '५', '६', '७', '८', '९'] as const;
...
export const MAX_DAY_DIFF = 36898;
export const MIN_AD_YEAR = 1943; // 2000
export const MIN_BS_YEAR = 2000; // 1943
export const MIN_AD_MONTH = 3; // 0 (Baisakh)
export const MIN_AD_DAY= 14; // 1 (first day)
export const MILLS_IN_DAY =   86400000; // 24*60*60*1000